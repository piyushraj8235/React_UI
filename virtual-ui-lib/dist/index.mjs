...
import React26, { useState as useState23 } from "react";
var GoalkeeperGloveCard = ({
  ...
  return /* @__PURE__ */ React26.createElement(
    ...
    /* @__PURE__ */ React26.createElement("div", { style: { position: "relative", width: "100%", height: "200px", overflow: "hidden" } }, /* @__PURE__ */ React26.createElement("img", { src: image, alt: model, style: { width: "100%", height: "100%", objectFit: "cover", transform: hovered ? "scale(1.05)" : "scale(1)", transition: "transform 0.4s ease" } }), discount > 0 && /* @__PURE__ */ React26.createElement("div", { style: { position: "absolute", top: "12px", right: "12px", padding: "4px 10px", borderRadius: "20px", background: alpha("#e11d48", 0.85), fontSize: "12px", fontWeight: "700", color: "#fff", textTransform: "uppercase", letterSpacing: "0.5px" } }, "-", discount, "%")),
    /* @__PURE__ */ React26.createElement("div", { style: { padding: "18px" } }, /* @__PURE__ */ React26.createElement("div", { style: { fontSize: "12px", color: "rgba(255,255,255,0.45)", marginBottom: "6px" } }, brand), /* @__PURE__ */ React26.createElement("h3", { style: { fontSize: "16px", fontWeight: "700", color: "#fff", margin: "0 0 8px", lineHeight: 1.4 } }, model), /* @__PURE__ */ React26.createElement("div", { style: { display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" } }, /* @__PURE__ */ React26.createElement("div", { style: { display: "flex", alignItems: "center", gap: "4px" } }, [...Array(5)].map((_, i) => /* @__PURE__ */ React26.createElement("svg", { key: i, width: "12", height: "12", viewBox: "0 0 24 24", fill: i < Math.floor(rating) ? "#fbbf24" : "rgba(255,255,255,0.15)", stroke: "none" }, /* @__PURE__ */ React26.createElement("path", { d: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" })))), /* @__PURE__ */ React26.createElement("div", { style: { fontSize: "12px", color: "rgba(255,255,255,0.45)" } }, "(", reviews, ")")), /* @__PURE__ */ React26.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "18px" } }, /* @__PURE__ */ React26.createElement("div", { style: { fontSize: "20px", fontWeight: "800", color: accent } }, currency, discountedPrice.toFixed(2)), discount > 0 && /* @__PURE__ */ React26.createElement("div", { style: { fontSize: "14px", color: "rgba(255,255,255,0.35)", textDecoration: "line-through" } }, currency, price.toFixed(2))), /* @__PURE__ */ React26.createElement("div", { style: { display: "flex", gap: "10px" } }, /* @__PURE__ */ React26.createElement(
      "button",
      {
        onClick: onAddToCart,
