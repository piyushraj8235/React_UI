      ...
      Sign in first to browse prebuilt components, live previews, and usage guides.
        ...
        <div className="w-full max-w-md mx-auto text-left space-y-4 mb-8">
          ...
          <div>
            ...
            <CodeBlock code={`npm i piyushraj-virtual-ui-component-lib`} lang="bash" />
          </div>
          ...
          <div>
            ...
            <CodeBlock code={`import { ComponentName } from "piyushraj-virtual-ui-component-lib";`} lang="jsx" />
          </div>
          ...
          <div>
            ...
            <CodeBlock
              code={`import { UserAvatar, PricingCard } from "piyushraj-virtual-ui-component-lib";\n\nexport default function App() {\n  return (\n    <div>\n      <UserAvatar src="/user.png" />\n      <PricingCard title="Pro" price={99} />\n    </div>\n  );\n}`}
              lang="jsx"
            />
          </div>
        </div>
...
function DetailPanel({ component, onBack }) {
  ...
  const importCode = `import { ${component.name} } from "piyushraj-virtual-ui-component-lib";`;
  const usageCode = `import { ${component.name} } from "piyushraj-virtual-ui-component-lib";\n\nexport default function App() {\n  return (\n    <div>\n      <${component.name}${
